% gpucbProbabilisticPeakRanksWithSwitchingCost(NUM_TRAIN,NUM_TRIALS,GRIDDING_PARAM,SCALE_PARAM)

function gpucbProbabilisticPeakRanksWithSwitchingCost(NUM_TRAIN,NUM_TRIALS,GRIDDING_PARAM,SCALE_PARAM)
